...
CREATE TABLE `userdevice` (
  ...
  CONSTRAINT `userdevice_ibfk_1` FOREIGN KEY (`UserID`) REFERENCES `user` (`UserID`),
  CONSTRAINT `userdevice_ibfk_2` FOREIGN KEY (`DeviceID`) REFERENCES `device` (`DeviceID`)
...
INSERT INTO `userdevice` VALUES (1,1),(1,2),(2,2),(5,2),(1,3),(1,4),(1,5),(2,5),(3,5),(5,5),(1,6),(4,6),(6,6),(1,7);
